...
state/               runtime records and signals; gitignored
  ...
  <id>.worktree-returned  touched by fm-teardown immediately after this task's pool-worktree return succeeds so a rerun cannot reset a reissued slot; removed by teardown

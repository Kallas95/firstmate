...
FM_CLAUDE_TURNEND_STALL_BUDGET=7   # consecutive --claude guard re-blocks, counted unkeyed, before the same one-time attended fail-open opens without any auto-arm failure evidence; bounds a Stop auto-arm that never claims the home at all and alarms before Claude's eight-block override

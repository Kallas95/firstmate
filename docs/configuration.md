...
FM_PAUSE_RESURFACE_SECS=3600       # seconds before an idle declared external wait, a dead-agent captain hold, or a provably-working crew parked on a still-open captain decision re-surfaces for a recheck in the watcher or away-mode daemon

...
| `/update-toolchain` | Inventory and sequentially apply verified stable updates for Pi and its catalogs and managed extensions, Claude Code, Codex, Herdr, no-mistakes, quota-axi, Treehouse, the supporting Firstmate tools, and pending Homebrew packages while deferring anything that could disturb active work |
